...
public class Auto {
    ...
    public Auto(String color, String marca, String modelo, int numeroPasajeros) {
        this.color = color;
        this.marca = marca;
        this.modelo = modelo;
    ...
    public Auto(String color, String marca, String modelo, String tipoEje, String tipoMotor, int anio, int numeroPasajeros, float caballosFuerza) {
        this.color = color;
        this.marca = marca;
        this.modelo = modelo;
